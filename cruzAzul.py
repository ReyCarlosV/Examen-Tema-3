...
class CruzAzul(Equipo):
    ...
    def get_contrincante_uno(self):
        return self._contrincante_uno

    def set_contrincante_uno(self, contrincante_uno):
        self._contrincante_uno = contrincante_uno

    def get_contrincante_dos(self):
        return self._contrincante_dos

    def set_contrincante_dos(self, contrincante_dos):
        self._contrincante_dos = contrincante_dos
